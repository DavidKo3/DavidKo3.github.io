...
![fig_1](paper_review_david/aessets/img_1/fig_1.png)
...
![fig_2](paper_review_david/aessets/img_1/fig_2.png)
...
![disparity](paper_review_david/aessets/img_1/disparity.png)

### 2. Pseudo-LiDAR generation

각각의 pixel (u, v) 에 대한 3D 좌표 (x,y, z) 값은 다음과 같이 구합니다.

![real_3d_coordinate](paper_review_david/aessets/img_1/real_3d_coordinate.png)



이런 방식으로 depth-map에 포함된 모든 픽셀에 대한 3D 좌표정보(x,y,z)를 추출하여 3D point cloud 데이터를 복원 할 수 있습니다. 

![projection_3d_lidar](paper_review_david/aessets/img_1/projection_3d_lidar.png)
...
![4_3d_object_dection_frustum](paper_review_david/aessets/img_1/4_3d_object_dection_frustum.png)
...
![4_3d_object_detection_BEV](paper_review_david/aessets/img_1/4_3d_object_detection_BEV.png)
...
이와 대조적으로 point cloud 데이터(3D points) 에 3D convolution을 적용하거나 birds's-eye view slices(BEV, 2D points)의 pixel에 2D convolution를 적용하는 경우는 실제 물리적으로 픽셀 영역이 가까운 부분들입니다. 따라서 이러한 경우의 operation들은 실제 물리적으로 의미가 있고  학습이 더 잘 되거나 정확한 모델을 구성할 수 있습니다. 이러한 점을 확인하기 위해서 그림 3(Figure 3) 과 같은 상황을 가정해서 실험을 진행 하였습니다. 즉 depth-map에 직접 2d convolution 을 적용해 본 것 입니다.
   ...
   ![5_representation_matters](paper_review_david/aessets/img_1/5_representation_matters.png)
...
![6_experiment_table_1](paper_review_david/aessets/img_1/6_experiment_table_1.png)
...
![6_experimant_results_table_2](paper_review_david/aessets/img_1/6_experimant_results_table_2.png)
...
![6_experiment_results_table_3](paper_review_david/aessets/img_1/6_experiment_results_table_3.png)
...
![6_experiment_table_4](paper_review_david/aessets/img_1/6_experiment_table_4.png)
...
![6_experiment_table_5](paper_review_david/aessets/img_1/6_experiment_table_5.png)
...
![8_visualization_figure_4](paper_review_david/aessets/img_1/8_visualization_figure_4.png)
...
![8_visualization_figure_5](paper_review_david/aessets/img_1/8_visualization_figure_5.png)
...
![image-20200727133723093](paper_review_david/aessets/img_1/fig_6.png)
...
![8_visualziation_figure_7](paper_review_david/aessets/img_1/8_visualziation_figure_7.png)
...
![figure_9](paper_review_david/aessets/img_1/figure_9.png)
